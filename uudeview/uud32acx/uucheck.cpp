...
char *
UUDWrap::UUGetFileName (char *subject, char *ptonum, char *ptonend)
{
...
int
UUDWrap::UUGetPartNo (char *subject, char **where, char **whend)
{
...
uufile *
UUDWrap::UUPreProcessPart (fileread *data, int *ret)
{
...
int
UUDWrap::UUInsertPartToList (uufile *data)
{
...
uulist *
UUDWrap::UUCheckGlobalList (void)
{
